...
if(isset($_POST['submit'])){
   ...
   $sql1 = "INSERT INTO `$db_name.11` (Img,Full_Name, Email,University, Phone_Number,Addres, DOB,Passwordd) VALUES ('$image_target_path','$full_name', '$email','$uni', '$num','$address', '$dob','$password')";
...
<div class="form-outline mb-4">Enter Your Medical ID :
    <input type="text" name="db_name" id="form3Example1cg" class="form-control form-control-lg" />
  </div>
